...
public final class PictureMimeType {
    public static int ofAll() {
        return FunctionConfig.TYPE_ALL;
    }

    public static int ofImage() {
        return FunctionConfig.TYPE_IMAGE;
    }

    public static int ofVideo() {
        return FunctionConfig.TYPE_VIDEO;
    }

    public static int ofAudio() {
        return FunctionConfig.TYPE_AUDIO;
    }
...
//            case "video/mp2ts":
     ...
     */
    public static boolean isLongImg(PhotoInfo media) {
        if (null != media) {
