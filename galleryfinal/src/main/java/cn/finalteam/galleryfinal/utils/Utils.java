...
public class Utils {
    ...
    /* 是否显示手机拍照
    * 由于某些手机拍照会导致崩溃 但奔溃日志无法获得 解决方案是暂时屏蔽某些机型的手机拍照功能
    * */
    public static boolean disableTakePhoto(){
        ...
        if( (man!=null && man.toUpperCase().contains("VIVO")) || (brand!=null && brand.toUpperCase().contains("VIVO")) ){
            isVivo =  true;
        }
        //VIVO X9SP; VIVO X20A
        return true == isVivo && (model.toUpperCase().contains("X9SP") || model.toUpperCase().contains("X20A"));
    }
