...
//                setCropSaveException(e);
    ...
    private class Cropper {
        ...
        private void makeDefault() {
            ...
            HighlightView hv = new HighlightView(imageView, getResources().getColor(R.color.ok_pressed));
    ...
    private void saveOutput(Bitmap croppedImage, File saveFile) {
        if (saveFile != null) {
            ...
            ///
            File destFile = CropUtil.getFromMediaUri(this, getContentResolver(), Uri.fromFile(saveFile));
            File sourceFile = CropUtil.getFromMediaUri(this, getContentResolver(), sourceUri);
            Log.d("CropImageActivity"," source file: " + sourceFile.getAbsolutePath() + ":" + sourceFile.getName());
            Log.d("CropImageActivity"," dest file: " + destFile.getAbsolutePath() + ":" + destFile.getName());
