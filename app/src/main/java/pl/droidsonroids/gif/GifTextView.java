...
//		if ( attrs != null )
//		{
//			Drawable left = getGifOrDefaultDrawable( attrs.getAttributeResourceValue(
//					GifImageView.ANDROID_NS , "drawableLeft" , 0 ) ) , right = getGifOrDefaultDrawable( attrs
...
//			setBackgroundInternal( getGifOrDefaultDrawable( attrs.getAttributeResourceValue(
//					GifImageView.ANDROID_NS , "background" , 0 ) ) );
//		}
//	}
//
...
//	@TargetApi ( Build.VERSION_CODES.JELLY_BEAN_MR1 )
//	@Override
//	public void setCompoundDrawablesRelativeWithIntrinsicBounds( int start , int top ,
//			int end , int bottom )
//	{
//		setCompoundDrawablesRelativeWithIntrinsicBounds( getGifOrDefaultDrawable( start ) ,
//				getGifOrDefaultDrawable( top ) , getGifOrDefaultDrawable( end ) ,
//				getGifOrDefaultDrawable( bottom ) );
//	}
//
//	@Override
//	public void setCompoundDrawablesWithIntrinsicBounds( int left , int top , int right ,
//			int bottom )
//	{
