...
public class GifDrawable extends Drawable implements Animatable , MediaPlayerControl
{
	 ...
	 * @param canvas
	 *            canvas to draw into
	 * @Override public void draw ( Canvas canvas ) { if ( mIsRunning )
	 *           renderFrame( mColors, mGifInfoPtr, mMetaData ); else mMetaData[
	 *           4 ] = -1; canvas.drawBitmap( mColors, 0, mMetaData[ 0 ], 0f,
	 *           0f, mMetaData[ 0 ], mMetaData[ 1 ], true, mPaint ); if (
	 *           mMetaData[ 4 ] >= 0 && mMetaData[ 2 ] > 1 )
	 *           UI_HANDLER.postDelayed( mInvalidateTask, mMetaData[ 4 ]
	 *           );//TODO don't post if message for given frame was already
	 *           posted }
	 */
