...
public class DragSortController extends SimpleFloatViewManager implements View.OnTouchListener, GestureDetector.OnGestureListener {
     ...
     * and ON_DOWN drag getVisitorList. By default, sorting is enabled, and
     * removal is disabled.
     *
     ...
     *
     * @param mode The drag getVisitorList mode.
     */
     ...
     *
     * @return The list position to drag if a drag-getVisitorList gesture is
