...
public class ChatBarZoomWindowHelper {
    private static final String TAG = "ChatBarZoomWindowHelper";
    ...
    private static ChatBarZoomWindowHelper sInstance = null;
    ...
    public static ChatBarZoomWindowHelper getInstance() {
        if (null == sInstance) {
            synchronized (ChatBarZoomWindowHelper.class) {
                if (null == sInstance) {
                    sInstance = new ChatBarZoomWindowHelper();
                }
            }
        }
        return sInstance;
    ...
    public boolean checkPermission() {
        if (!Settings.canDrawOverlays(mContext)) {
            ...
            if (null != current) {
                Dialog dialog = DialogUtil.showTowButtonDialog(current,
    ...
    private ChatBarZoomWindowHelper() {
