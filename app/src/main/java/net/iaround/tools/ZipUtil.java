...
public class ZipUtil {
     ...
     * @throws Exception
     */
    public static java.util.List<java.io.File> GetFileList(String zipFileString,
     ...
     * @throws Exception
     */
    public static java.io.InputStream UpZip(String zipFileString, String fileString)
            throws Exception {
    ...
    public static void UnZipFolder(String zipFileString, String outPathString)
        ...
        while ((zipEntry = inZip.getNextEntry()) != null) {
            ...
            if (zipEntry.isDirectory()) {
                ...
                // get the folder name of the widget
                szName = szName.substring(0, szName.length() - 1);
                java.io.File folder = new java.io.File(outPathString + java.io.File.separator
                        + szName);
                folder.mkdirs();
