...
public class AnimationController {
    public static final int RELA_1 = Animation.RELATIVE_TO_SELF;
    public static final int RELA_2 = Animation.RELATIVE_TO_PARENT;
    ...
    private static void baseIn(View view, Animation animation, long durationMillis,
                               long delayMillis) {
    ...
    private static void baseOut(View view, Animation animation, long durationMillis,
                                long delayMillis) {
        setEffect(animation, Default, durationMillis, delayMillis);
    ...
    public static void slideIn(View view, long durationMillis, long delayMillis) {
        TranslateAnimation animation = new TranslateAnimation(RELA_2, 1, RELA_2, 0,
                RELA_2, 0, RELA_2, 0);
        baseIn(view, animation, durationMillis, delayMillis);
    }

    public static void slideOut(View view, long durationMillis, long delayMillis) {
        TranslateAnimation animation = new TranslateAnimation(RELA_2, 0, RELA_2, -1,
                RELA_2, 0, RELA_2, 0);
        baseOut(view, animation, durationMillis, delayMillis);
    }

    public static void scaleIn(View view, long durationMillis, long delayMillis) {
        ScaleAnimation animation = new ScaleAnimation(0, 1, 0, 1, RELA_2, 0.5f, RELA_2,
                0.5f);
        baseIn(view, animation, durationMillis, delayMillis);
    }

    public static void scaleOut(View view, long durationMillis, long delayMillis) {
        ScaleAnimation animation = new ScaleAnimation(1, 0, 1, 0, RELA_2, 0.5f, RELA_2,
                0.5f);
        baseOut(view, animation, durationMillis, delayMillis);
    }

    public static void rotateIn(View view, long durationMillis, long delayMillis) {
        RotateAnimation animation = new RotateAnimation(-90, 0, RELA_1, 0, RELA_1, 1);
        baseIn(view, animation, durationMillis, delayMillis);
    }

    public static void rotateOut(View view, long durationMillis, long delayMillis) {
        RotateAnimation animation = new RotateAnimation(0, 90, RELA_1, 0, RELA_1, 1);
        baseOut(view, animation, durationMillis, delayMillis);
    }

    public static void scaleRotateIn(View view, long durationMillis, long delayMillis) {
        ScaleAnimation animation1 = new ScaleAnimation(0, 1, 0, 1, RELA_1, 0.5f,
                RELA_1, 0.5f);
        RotateAnimation animation2 = new RotateAnimation(0, 360, RELA_1, 0.5f, RELA_1,
                0.5f);
    ...
    public static void scaleRotateOut(View view, long durationMillis, long delayMillis) {
        ScaleAnimation animation1 = new ScaleAnimation(1, 0, 1, 0, RELA_1, 0.5f,
                RELA_1, 0.5f);
        RotateAnimation animation2 = new RotateAnimation(0, 360, RELA_1, 0.5f, RELA_1,
                0.5f);
        AnimationSet animation = new AnimationSet(false);
    ...
    public static void slideFadeIn(View view, long durationMillis, long delayMillis) {
        TranslateAnimation animation1 = new TranslateAnimation(RELA_2, 1, RELA_2, 0,
                RELA_2, 0, RELA_2, 0);
    ...
    public static void slideFadeOut(View view, long durationMillis, long delayMillis) {
        TranslateAnimation animation1 = new TranslateAnimation(RELA_2, 0, RELA_2, -1,
                RELA_2, 0, RELA_2, 0);
