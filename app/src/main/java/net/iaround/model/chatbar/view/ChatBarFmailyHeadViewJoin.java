...
public class ChatBarFmailyHeadViewJoin extends RelativeLayout {
    private Context mContext;
    private ChatBarFamilyType mChatBarFamilyType;
    private ImageView ivMyFamilyIcon;
    private TextView tvMyFamilyText;

    public ChatBarFmailyHeadViewJoin(Context context, ChatBarFamilyType chatBarFamilyType) {
        super(context);
    ...
    private void initView() {
        View itemView = LayoutInflater.from(mContext).inflate(
                R.layout.chat_bar_my_family_headview_join, this);
    ...
    public ChatBarFmailyHeadViewJoin(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ChatBarFmailyHeadViewJoin(Context context, AttributeSet attrs, int defStyleAttr) {
