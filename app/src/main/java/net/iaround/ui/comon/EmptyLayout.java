...
public class EmptyLayout
{
	...
	/**
	 * @Title: initMessages
	 * @Description: init the default message
	 * @param context
	 */
	private void initMessages( Context context )
	{
		mEmptyMessage = context.getString( R.string.content_is_empty );
		mErrorMessage = context.getString( R.string.content_is_error );
		mLoadingMessage = context.getString( R.string.content_is_loading );
	}
	...
	{
		this.mEmptyView.setOnClickListener( emptyViewClickListener );
	}
}
