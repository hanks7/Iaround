 ...
 * {@link QuickActionChatBar} adds secondary actions to an item of a ListView.
 * 
 */
public class QuickActionChatBar extends QuickActionWidget
{
	...
	public QuickActionChatBar(Context context , boolean isOnLeft )
	{
		super( context );
		
		// mRackAnimation = AnimationUtils.loadAnimation(context,
		// R.anim.gd_rack);
		//
		...
		setContentView( R.layout.gd_quick_action_chat_bar );
	...
	protected void onMeasureAndLayout(Rect anchorRect , View contentView )
	{
		...
		int popupY = ( onTop ) ? anchorRect.top - rootHeight + offsetY : anchorRect.bottom
				- offsetY;
	...
	protected void populateQuickActions( List< QuickAction > quickActions )
	{
		...
		for ( QuickAction action : quickActions )
		{
			TextView view = (TextView) inflater.inflate(
					R.layout.gd_quick_action_chat_bar_item , mQuickActionItems , false );
			view.setText( action.mTitle );
			
			if ( index > 0 )
			{
				view.setCompoundDrawablesWithIntrinsicBounds( getContext( ).getResources( )
						.getDrawable( R.drawable.quick_action_chat_bar_v_line ) , null , null ,
						null );
			}
		...
		public void onClick( View view )
		{
			...
			if ( listener != null )
			{
				...
				for ( int i = 0 ; i < itemCount ; i++ )
				{
					...
					{
						listener.onQuickActionClicked( QuickActionChatBar.this , i );
						break;
					}
				}
			}
