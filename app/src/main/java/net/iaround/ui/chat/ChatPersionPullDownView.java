...
public class ChatPersionPullDownView extends FrameLayout implements OnGestureListener
{
	...
	public ChatPersionPullDownView( Context context )
	{
		this( context , null );
	}
	
	public ChatPersionPullDownView(Context context , AttributeSet attrs )
	{
		this( context , attrs , 0 );
	}
	
	public ChatPersionPullDownView(Context context , AttributeSet attrs , int defStyle )
	{
	...
	protected void onLayout( boolean changed , int left , int top , int right , int bottom )
	{
		if ( !this.bAD )
		{
			View localView2 = inflate( this.context , R.layout.chat_loading_more , null );
			View localView1 = inflate( this.context , R.layout.chat_loading_more , null );
