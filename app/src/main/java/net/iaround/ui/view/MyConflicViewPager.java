...
public class MyConflicViewPager extends ViewPager {
    public MyConflicViewPager(Context context) {
        super(context);
    }

    public MyConflicViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
