...
public class DragNullPointView extends TextView {
    private boolean initBgFlag;
    private int backgroundColor = Color.parseColor("#FF4064");
    private PointView pointView;
    private int x, y, r;
    private ViewGroup scrollParent;
    private int[] p = new int[2];

    public DragNullPointView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initbg();
    }
    ...
    public void setBackgroundColor(int backgroundColor) {
        ...
        DragNullPointView.this.setBackgroundDrawable(createStateListDrawable((getHeight() > getWidth() ? getHeight()
    ...
    private void initbg() {
        ...
        getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            ...
            public boolean onPreDraw() {
                if (!initBgFlag) {
                    DragNullPointView.this.setBackgroundDrawable(createStateListDrawable(
        ...
        public void cancel() {
            ...
            set.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    DragNullPointView.this.setVisibility(View.VISIBLE);
                }
            });
            set.start();
